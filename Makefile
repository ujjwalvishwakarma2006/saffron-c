...
SRCS = main.c common.c args.c ui.c server.c client.c key_exchange.c crypto.c outgoing.c msg_recv.c file_recv.c
OBJS = $(SRCS:.c=.o)
TARGET = saffron
...
main.o: main.c common.h args.h ui.h server.h client.h key_exchange.h crypto.h outgoing.h msg_recv.h file_recv.h